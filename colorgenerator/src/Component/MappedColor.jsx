...
export const MappedColor = ({ rgb, weight, MouseEffect, hex, index }) => {
	...
	return (
		<div
			className={`border-yellow-700 ${index > 10 ? `text-white` : `shadow-md`} hover:cursor-pointer`}
			onClick={ClipBoard}
		>
			<div className="p-3 relative" onMouseOver={() => MouseEffect(bcg)} style={{ background: `rgb(${bcg})` }}>
